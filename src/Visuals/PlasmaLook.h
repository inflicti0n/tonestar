...
struct PlasmaLook
{
    ...
    float confinement = 0.00f;
    float swirl = 0.05f;
    float inject = 0.84f;
    float dyeFade = 0.00f;
    float idleAlpha = 1.00f;
    float stormBoost = 2.50f;

    juce::Colour deep { 0xff95fbf8 };
    juce::Colour body { 0xff4d92ad };
    juce::Colour core { 0xffb7afb6 };
    juce::Colour hot { 0xffddcaa5 };
    juce::Colour accent { 0xffba93ac };

    float ringAmount = 0.00f;
    float ringRotate = 0.16f;
    float ringGain = 1.85f;
    float ringSmooth = 0.95f;
    float ringThick = 1.85f;
    float ringGlow = 0.55f;
    float ringIdle = 0.38f;
    float ringFill = 1.00f;
